---
name: "source-command-natt"
description: "Arbeta självständigt igenom kön och skriv en morgonrapport."
---

# source-command-natt

Use this skill when the user asks to run the migrated source command `natt`.
...
3. Ta egna beslut i frågor om innehåll, design och kod. Det enda som blockeras är sådant som kräver Niclas enligt AGENTS.md: push, deploy, hemligheter, massutskick, personfakta om Niclas och rättigheter till hela texter.
