---
titel: "Ogranskade ChatGPT-länkar bakom regeringens spec-utbildningsförslag"
ingress: "I referenslistan till En ny speciallärarutbildning (SOU 2026:50) är 29 av 55 poster studentuppsatser, spårningslänkar från ChatGPT och Google ligger kvar, och tre hänvisningar pekar på filer i någons nedladdningsmapp. Krönikan följer källorna och frågar varför remissinstanserna ska göra statens källkritiska hemläxa."
datum: 2026-09-08
...
Förra veckan var jag ute på en skola för att hjälpa speciallärarna att komma i gång med stödundervisning. Eleven ska få stöd snabbt och direkt, när svårigheterna uppstår. Runt bordet satt en rektor, en förstelärare och en specialpedagog, och när vi reste oss hade åtta elever plockats ut som börjar på måndag. Såvitt jag förstår är det precis vad utredningen vill åstadkomma, och det skedde utan en enda ny examensordning.
...
Huvudbetänkandet innehåller fullständiga Google-annons/spårningslänkar. Man har suttit och googlat, och klistrat in webbadresser från den väg man råkat hitta källan.
...
Huvudbetänkandet innehåller också fullständiga Google-annons/spårningslänkar, med utm_source=google, gclid, kampanj-ID:n med mera. De ligger kvar både i noter och referenslista. Källförteckningen verkar med andra ord generellt ha byggts genom att man suttit och googlat, och klistrat in webbadresser från den väg man råkade hitta källan.
