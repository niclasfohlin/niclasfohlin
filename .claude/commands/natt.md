...
6. När kön är genomarbetad: `git switch main && git merge natt/<datum> && git push`. Netlify bygger main. Vänta in bygget och kontrollera att det blev grönt; blev det rött, laga på en ny commit eller backa med `git revert`.
